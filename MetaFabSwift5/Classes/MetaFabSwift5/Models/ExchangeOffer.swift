...
public struct ExchangeOffer: Codable, JSONEncodable, Hashable {
    ...
    public init(id: Double? = nil, inputCollection: String? = nil, inputCollectionItemIds: [Double]? = nil, inputCollectionItemAmounts: [Double]? = nil, inputCurrency: String? = nil, inputCurrencyAmount: Double? = nil, outputCollection: String? = nil, outputCollectionItemIds: [Double]? = nil, outputCollectionItemAmounts: [Double]? = nil, outputCurrency: String? = nil, outputCurrencyAmount: Double? = nil, uses: Double? = nil, maxUses: Double? = nil, lastUpdatedAt: Double? = nil) {
        self.id = id
