...
public struct PublicEcosystem: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String? = nil, name: String? = nil, publishedKey: String? = nil, iconImageUrl: String? = nil, coverImageUrl: String? = nil, primaryColorHex: String? = nil, updatedAt: String? = nil, createdAt: String? = nil) {
        self.id = id
        self.name = name
