...
public struct WithdrawFromShopRequest: Codable, JSONEncodable, Hashable {
    ...
    public init(address: String? = nil, walletId: String? = nil, currencyAddress: String? = nil, currencyId: String? = nil, collectionAddress: String? = nil, collectionId: String? = nil, itemIds: [Int]? = nil) {
