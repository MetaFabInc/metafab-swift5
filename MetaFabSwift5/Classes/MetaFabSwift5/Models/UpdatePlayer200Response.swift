...
public struct UpdatePlayer200Response: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String? = nil, gameId: String? = nil, walletId: String? = nil, connectedWalletId: String? = nil, profileId: String? = nil, username: String? = nil, accessToken: String? = nil, profilePermissions: AnyCodable? = nil, updatedAt: String? = nil, createdAt: String? = nil, walletDecryptKey: String? = nil) {
        self.id = id
        self.gameId = gameId
