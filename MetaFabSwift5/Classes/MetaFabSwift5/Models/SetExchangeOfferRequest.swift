...
public struct SetExchangeOfferRequest: Codable, JSONEncodable, Hashable {
    ...
    public var inputCollectionItemIds: [Double]?
    ...
    public var inputCollectionItemAmounts: [Double]?
    ...
    public var outputCollectionItemIds: [Double]?
    ...
    public var outputCollectionItemAmounts: [Double]?
    ...
    public init(id: Double, inputCollectionAddress: String? = nil, inputCollectionId: String? = nil, inputCollectionItemIds: [Double]? = nil, inputCollectionItemAmounts: [Double]? = nil, inputCurrencyAddress: String? = nil, inputCurrencyId: String? = nil, inputCurrencyAmount: Double? = nil, outputCollectionAddress: String? = nil, outputCollectionId: String? = nil, outputCollectionItemIds: [Double]? = nil, outputCollectionItemAmounts: [Double]? = nil, outputCurrencyAddress: String? = nil, outputCurrencyId: String? = nil, outputCurrencyAmount: Double? = nil, maxUses: Double? = nil) {
        self.id = id
