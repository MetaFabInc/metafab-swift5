...
public struct GetCurrencies200ResponseInner: Codable, JSONEncodable, Hashable {
    ...
    public init(id: String? = nil, gameId: String? = nil, contractId: String? = nil, name: String? = nil, symbol: String? = nil, supplyCap: Int? = nil, updatedAt: String? = nil, createdAt: String? = nil, contract: ContractModel? = nil) {
        self.id = id
        self.gameId = gameId
